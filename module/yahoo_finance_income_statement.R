...
yahoo_finance_income_statement_ui <- function(id) {
...
PURI.JK", height = 250, width = 260),
                              ...
                              textAreaInput(ns("get_var_financial"), "Variable(s)", value = "Total Revenue\nNet Income Common Stockholders\nBasic EPS\nBasic Average Shares", height = 150, width = 260),
...
yahoo_finance_income_statement_server <- function(input, output, session) {
